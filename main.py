...
### ____________________set model parameters_______________________
...
##___________________ load dataset and train model________________________
...
### __________________________sample from model______________________________
gif_shape = [3, 3]
